...
public final class MetadataUtil
{
    ...
    public static final JsonCodec<Map<String, List<LuceneTable>>> CATALOG_CODEC;
    public static final JsonCodec<LuceneTable> TABLE_CODEC;
    public static final JsonCodec<LuceneColumnHandle> COLUMN_CODEC;
    ...
    static {
        ...
        CATALOG_CODEC = codecFactory.mapJsonCodec(String.class, listJsonCodec(LuceneTable.class));
        TABLE_CODEC = codecFactory.jsonCodec(LuceneTable.class);
        COLUMN_CODEC = codecFactory.jsonCodec(LuceneColumnHandle.class);
    }

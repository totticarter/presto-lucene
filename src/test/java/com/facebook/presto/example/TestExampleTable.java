...
{
    private final LuceneTable exampleTable = new LuceneTable("tableName",
            ImmutableList.of(new LuceneColumn("a", createUnboundedVarcharType()), new LuceneColumn("b", BIGINT)),
            ...
            throws Exception
    {
        ...
        LuceneTable exampleTableCopy = TABLE_CODEC.fromJson(json);
